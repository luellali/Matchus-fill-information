...
const groups = [
  { title: "家庭背景", options: ["🏠 已购房", "🏡 有房有车", "👧 独生子女", "🏢 体制内家庭", "🚗 已购车", "👫 有兄弟姐妹", "💼 经商家庭", "💕 家庭氛围和睦", "🌇 本地家庭"] },
  { title: "成长背景", options: ["🎗️ 曾经是学霸", "🌍 有留学经历", "🏃 体育生", "📚 考公人", "🎓 本科在读", "📚 硕士在读", "🔬 博士在读", "🎨 艺术类专业", "🗣️ 多语言能力"] },
  { title: "择偶偏向", options: ["📍 同城优先", "🎓 学历相近", "💬 聊得来最重要", "🎓 智性恋爱好者", "💞 寻找长期关系", "🌈 性格互补", "👀 看重第一眼感觉", "🤝 温柔体贴", "🚭 不抽烟", "☀️ 喜欢情绪稳定", "🏃 偏爱运动型", "🧠 偏爱上进型"] },
  { title: "兴趣爱好", options: ["🏋️ 有健身习惯", "🐱 大橘大利", "🥾 户外运动", "🎬 电影", "📸 摄影", "✈️ 旅行", "🎵 现场音乐", "🍳 做饭", "🖼️ 看展"] },
] as const
