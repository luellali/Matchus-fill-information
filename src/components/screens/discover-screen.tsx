  ...
  return (
    <PageFrame className="animate-screen-in">
      <div className="relative flex min-h-0 flex-1 flex-col px-[var(--page-inline)] pb-5">
        <div className="relative mt-1 flex min-h-0 flex-1 flex-col overflow-hidden rounded-[28px] border border-white/80 bg-white shadow-[var(--shadow-card)]">
          <div className="relative min-h-[48%] overflow-hidden bg-[#1e1731]">
            ...
            <button className="absolute bottom-5 right-4 grid size-11 place-items-center rounded-full bg-white text-primary shadow-lg" aria-label="喜欢">
              <Heart className="size-5 fill-primary" />
            </button>
            <button className="absolute bottom-20 right-4 grid size-11 place-items-center rounded-full bg-white/90 text-foreground/55 shadow-lg" aria-label="暂不喜欢">
              <X className="size-5" />
            </button>
          </div>
          ...
          <div className="no-scrollbar min-h-0 flex-1 overflow-y-auto bg-white">
            <CardContent className="space-y-4 p-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  "from-[#eedcff] to-[#9f83e7]",
                  "from-[#fde2ed] to-[#d484ae]",
                  "from-[#e5e4ff] to-[#7d75b8]",
                ].map((gradient) => (
